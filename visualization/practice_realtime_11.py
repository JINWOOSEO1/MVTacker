...
def main():
    ...
    def render_image(rgb, depth, intr, extr):
        ...
        query_points_window = query_points_ls[-1]
        ...
        new_column = torch.full((pred_tracks.shape[2], 1), float(K-2), device=device, dtype = torch.float32)   
